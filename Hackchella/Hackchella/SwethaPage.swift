...
//  Hackchella
//
//  Created by Swetha Akella on 4/1/17.
...
//===========Delegate============================//
protocol SwethaPageDelegate {
    func goToMainMenu()
}
//===========Delegate============================//

class SwethaPageScene: SKScene {
    
    //===========Delegate============================//
    var swethaPageDelegate:SwethaPageDelegate?
    //===========Delegate============================//
    ...
    override func didMoveToView(view: SKView) {
        ...
        homeBackground.position = CGPoint(x: 540, y: 1720) //540
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        if let name = touchedNode.name {
            if (name == "homeButtonText" || name == "homeButtonBackground"){
                swethaPageDelegate!.goToMainMenu()
